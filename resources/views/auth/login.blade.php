    ...
    <div class="w-full max-w-[26rem] p-4 sm:px-5">
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <label class="block">
                ...
                <input
                    class="form-input peer @error('email') is-invalid @enderror w-full rounded-lg border border-slate-300 bg-transparent px-3 py-2 pl-9 placeholder:text-slate-400/70 hover:z-10 hover:border-slate-400 focus:z-10 focus:border-primary dark:border-navy-450 dark:hover:border-navy-400 dark:focus:border-accent"
            ...
            <div class="mt-4 flex items-center justify-between space-x-2">
                ...
                <a href="{{ route('password.request') }}" class="text-xs text-slate-400 transition-colors line-clamp-1 hover:text-slate-800 focus:text-slate-800 dark:text-navy-300 dark:hover:text-navy-100 dark:focus:text-navy-100">
                    Forgot Password?
                </a>
                @endif
            </div>
